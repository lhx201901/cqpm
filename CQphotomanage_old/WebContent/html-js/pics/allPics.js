...
//					html += '<span style="background: url('+imgurl+')"></span>';
				...
				$.each(data.rows, function(key, val) {
					html += '<li>';
					html += '<div class="picn" >';
					//html += '<a href="#" onclick=clickOne(\''+val.pic_lyljm+'\') ondblclick="clickdbl(\''+val.pic_xh+'\',\''+val.pic_mc+'\')">';
					html += '<a href="javascript:void(0)" >';
					html += '<p><img onclick=clickOne(\''+val.pic_lyljm+'\') ondblclick="clickdbl(\''+val.pic_xh+'\',\''+val.pic_mc+'\')" src="' + PICURI+val.pic_lylys+'"  onload="this.clientHeight > this.clientWidth ? this.style.height = \'100%\' : this.style.width = \'100%\'"></p>';
