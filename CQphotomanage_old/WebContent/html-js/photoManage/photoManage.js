...
function loadOperater(data){
	var html ="";
	html += '<a href="javascript:void();" onclick="lookDetails(\''+data.pic_xh+'\',\''+data.pic_mc+'\')">查看</a>';
 ...
 * @param twq
 */
function lookDetails(uuid,pic_mc){
	...
	parent.createPage(pic_mc,url , true, "picsDetail");
}
/**
 * 编辑图片
 * @param id
...
function setJG(id){
	...
	html += '<input type="text" class="text"  value="200" id="jg_text" oninput="chage()"'
